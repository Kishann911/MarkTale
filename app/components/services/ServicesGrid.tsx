                    ...
                    {services.map((service, index) => (
                        ...
                        >
                            <motion.div
                                ...
                                className="bg-neutral-50 p-6 md:p-8 rounded-2xl hover:bg-black hover:text-white transition-all duration-300 group border border-transparent hover:border-black/10 cursor-pointer h-full"
                            >
