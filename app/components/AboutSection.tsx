            ...
            <div className="container mx-auto px-6">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    >
                        ...
                        <button className="px-8 py-3 border-2 border-kestone-black text-kestone-black font-bold uppercase tracking-wider hover:bg-kestone-black hover:text-white transition-all duration-300">
                            Read Our Story
                        </button>
                    </motion.div>
